...
<head>
    <meta charset="UTF-8">
    <title>Sistema de Notas - Cursos</title>
...
<body>
    <div class="container mt-4">
        <nav class="mb-4">
            ...
            <a href="#" class="btn btn-primary me-2">Cursos</a>
        ...
        <a href="add.php" class="btn btn-success mb-3">Registrar Nuevo Curso</a>
            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="edit.php?Id=<?php echo $Curso['ID_CURSO'] ?>" class="btn btn-warning btn-sm">Editar</a>
                            <a href="asignar_asignaturas.php?Id=<?php echo $Curso['ID_CURSO'] ?>" class="btn btn-info btn-sm">Asignar Materias</a>
                            <a href="delete.php?Id=<?php echo $Curso['ID_CURSO'] ?>" class="btn btn-danger btn-sm">Eliminar</a>
                        </td>
                    </tr>
                    <?php 
                        }
